...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleFilters = sampleArray.filter(samp => samp.id == sample);
    ...
    var metaFilters = metaArray.filter(sampleObj => sampleObj.id == sample);

    //  5. Create a variable that holds the first sample in the array.
    var firstResult = sampleFilters[0]; 
    ...
    var metaWashFreq = firstMeta.wfreq;
    ...
    */
    ...
    var gaugeLayout = { 
      width: 550, height: 500, margin: { t: 0, b: 0 },
      font: { color: "black"},
      plot_bgcolor: "rgba(0,0,0,0)",
      paper_bgcolor: "rgba(0,0,0,0)"
    };
